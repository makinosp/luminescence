...
export interface IReportService {
   ...
   */
  getIncomeVsExpenses(period: ReportPeriod, customRange?: DateRange): Promise<IncomeVsExpensesReport>;

  /**
   * Get spending breakdown by category.
   */
  getSpendingByCategory(period: ReportPeriod, customRange?: DateRange): Promise<CategorySpending[]>;
